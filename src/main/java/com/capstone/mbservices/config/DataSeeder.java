    ...
    public void run(String... args) {
        ...
        if (storeRepository.count() == 0) {
            Store store1 = storeRepository.save(Store.builder()
                ...
                .address("Dại lộ Bình Dương, Phú Hòa, Thủ Dầu Một, Bình Dương")
                .phone("0900123456")
                .latitude(10.9726)
                .longitude(106.6851)
                .brand("YAMAHA")
            ...
            Store store2 = storeRepository.save(Store.builder()
                ...
                .address("Dường Lê Lợi, Phường Hòa Phú, TP. Bình Dương")
                .phone("0900654321")
                .latitude(11.0528)
                .longitude(106.6667)
                .brand("HONDA")
            ...
            Store store3 = storeRepository.save(Store.builder()
                ...
                .address("Dường Phú Lợi, Phường Phú Lợi, Thủ Dầu Một, Bình Dương")
                .phone("0900987654")
                .latitude(10.9820)
                .longitude(106.6660)
                .brand("SUZUKI")
            ...
            Store store4 = storeRepository.save(Store.builder()
                ...
                .address("Quốc lộ 13, Mỹ Phước, Bến Cát, Bình Dương")
                .phone("0900112233")
                .latitude(11.1000)
                .longitude(106.6100)
                .brand("HONDA")
